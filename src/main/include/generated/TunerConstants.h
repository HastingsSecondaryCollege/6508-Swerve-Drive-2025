...
namespace ElevatorConstants {
    ...
    constexpr double kElevatorClimbReady = 11.0;
    constexpr double kElevatorClimbDesired = 3.00; //0.44

    constexpr double kWristHome = 0.456;
    ...
    constexpr double kIntakeCoralTurnsSlow = -0.5;
